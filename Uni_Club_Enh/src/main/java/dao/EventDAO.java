...
public class EventDAO {
	...
	public List<Event> getAllUpcomingEvents() {
	    ...
	    try {
	        ...
	        // Updated SQL query for SQL Server
	        String sql = "SELECT * FROM events WHERE event_date >= CAST(GETDATE() AS DATE) ORDER BY event_date ASC";
	        ...
	        // Debug log to check the number of events retrieved
